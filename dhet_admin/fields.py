...
from dhet_admin.utils import display_for_field, prettify_json
from dhet_admin.widgets import (
    CHECKBOX_LABEL_CLASSES,
    LABEL_CLASSES,
    DhetAdminAdminAutocompleteModelChoiceFieldWidget,
    DhetAdminAdminMultipleAutocompleteModelChoiceFieldWidget,
)
...
class DhetAdminAdminReadonlyField(helpers.AdminReadonlyField):
    ...
    def _get_contents(self) -> SafeString:  # noqa: PLR0912
        from dhet_admin.utils import _boolean_icon
...
class DhetAdminAdminField(helpers.AdminField):
    def label_tag(self) -> SafeText:
        classes = []
...
class DhetAdminAdminAutocompleteModelChoiceField(
    AutocompleteFieldMixin, ModelChoiceField
):
    widget = DhetAdminAdminAutocompleteModelChoiceFieldWidget


class DhetAdminAdminMultipleAutocompleteModelChoiceField(
    AutocompleteFieldMixin, ModelMultipleChoiceField
):
    widget = DhetAdminAdminMultipleAutocompleteModelChoiceFieldWidget
