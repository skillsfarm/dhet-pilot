...
def _boolean_icon(field_val: Any) -> str:
    return render_to_string("dhet_admin/helpers/boolean.html", {"value": field_val})


def display_for_header(value: Iterable, empty_value_display: str) -> SafeText:
    if not isinstance(value, list) and not isinstance(value, tuple):
        raise DhetAdminException("Display header requires list or tuple")

    return mark_safe(
        render_to_string(
            "dhet_admin/helpers/display_header.html",
            {
                "value": value,
            },
        )
...
def display_for_dropdown(
    ...
    return render_to_string(
        "dhet_admin/helpers/display_dropdown.html",
        {
            "instance": result,
...
def display_for_label(value: Any, empty_value_display: str, label: Any) -> SafeText:
    ...
    return mark_safe(
        render_to_string(
            "dhet_admin/helpers/display_label.html",
            {
                "label": value,
