...
from dhet_admin.widgets import (
    INPUT_CLASSES,
    DhetAdminAdminCheckboxSelectMultiple,
    DhetAdminAdminRadioSelectWidget,
    DhetAdminAdminSelectMultipleWidget,
    DhetAdminAdminSelectWidget,
    DhetAdminAdminSplitDateTimeVerticalWidget,
    DhetAdminAdminTextInputWidget,
)
...
class SearchForm(forms.Form):
    def __init__(self, name: str, label: str, *args, **kwargs) -> None:
        ...
        self.fields[name] = forms.CharField(
            label=label,
            required=False,
            widget=DhetAdminAdminTextInputWidget,
        )
        ...
        **kwargs,
        ...
        self.fields[name] = self.field(
            ...
            widget=self.widget(
                ...
                attrs={"class": "dhet_admin-filter-autocomplete"},
            ),
        )
...
class CheckboxForm(forms.Form):
    ...
    widget = DhetAdminAdminCheckboxSelectMultiple
...
class RadioForm(CheckboxForm):
    field = ChoiceField
    widget = DhetAdminAdminRadioSelectWidget


class HorizontalRadioForm(RadioForm):
    horizontal = True
    widget = DhetAdminAdminRadioSelectWidget(radio_style=HORIZONTAL)


class DropdownForm(forms.Form):
    widget = DhetAdminAdminSelectWidget(
        attrs={
            "data-theme": "admin-autocomplete",
            "class": "dhet_admin-admin-autocomplete admin-autocomplete",
        }
    )
    field = ChoiceField
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if multiple:
            self.widget = DhetAdminAdminSelectMultipleWidget(
                attrs={
                    "data-theme": "admin-autocomplete",
                    "class": "dhet_admin-admin-autocomplete admin-autocomplete",
                }
...
class SliderNumericForm(RangeNumericForm):
    class Media:
        css = {"all": ("dhet_admin/filters/css/nouislider/nouislider.min.css",)}
        js = (
            "dhet_admin/filters/js/wnumb/wNumb.min.js",
            "dhet_admin/filters/js/nouislider/nouislider.min.js",
            "dhet_admin/filters/js/admin-numeric-filter.js",
        )
...
class RangeDateForm(forms.Form):
    class Media:
        js = [
            ...
            "dhet_admin/filters/js/DateTimeShortcuts.js",
        ]
...
class RangeDateTimeForm(forms.Form):
    ...
    def __init__(self, name: str, *args, **kwargs) -> None:
        ...
        self.fields[self.name + "_from"] = forms.SplitDateTimeField(
            label="",
            required=False,
            widget=DhetAdminAdminSplitDateTimeVerticalWidget(
                date_label="",
                date_attrs={
