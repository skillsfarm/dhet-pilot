...
from dhet_admin.contrib.filters.forms import RangeDateForm, RangeDateTimeForm
from dhet_admin.utils import parse_date_str, parse_datetime_str
...
class RangeDateFilter(admin.FieldListFilter):
    ...
    template = "dhet_admin/filters/filters_date_range.html"
...
class RangeDateTimeFilter(admin.FieldListFilter):
    request = None
    parameter_name = None
    template = "dhet_admin/filters/filters_datetime_range.html"
