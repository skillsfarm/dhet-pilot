...
from dhet_admin.contrib.filters.admin.mixins import RangeNumericMixin
from dhet_admin.contrib.filters.forms import SingleNumericForm, SliderNumericForm


class SingleNumericFilter(admin.FieldListFilter):
    request = None
    parameter_name = None
    template = "dhet_admin/filters/filters_numeric_single.html"
...
class SliderNumericFilter(RangeNumericFilter):
    ...
    template = "dhet_admin/filters/filters_numeric_slider.html"
    field = None
