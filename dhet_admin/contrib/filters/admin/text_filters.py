...
from dhet_admin.contrib.filters.admin.mixins import ValueMixin
from dhet_admin.contrib.filters.forms import SearchForm


class TextFilter(admin.SimpleListFilter):
    template = "dhet_admin/filters/filters_field.html"
