...
from dhet_admin.overrides import FORMFIELD_OVERRIDES
...
class BaseModelAdminMixin:
    ...
    def changeform_view(
        ...
        from dhet_admin.forms import AdminForm, Fieldline
    ...
    def formfield_for_choice_field(
        ...
        if "widget" not in kwargs:
            if db_field.name in self.radio_fields:
                kwargs["widget"] = widgets.DhetAdminAdminRadioSelectWidget(
                    radio_style=self.radio_fields[db_field.name]
                )
            else:
                kwargs["widget"] = widgets.DhetAdminAdminSelectWidget()
    ...
    def formfield_for_foreignkey(
        ...
        if "widget" not in kwargs:
            if db_field.name in self.raw_id_fields:
                kwargs["widget"] = widgets.DhetAdminForeignKeyRawIdWidget(
    ...
    def formfield_for_manytomany(
        ...
        **kwargs,
        ...
        if "widget" not in kwargs:
            if db_field.name in self.raw_id_fields:
                kwargs["widget"] = widgets.DhetAdminAdminTextInputWidget()
    ...
    def formfield_for_nullboolean_field(
        ...
        if "widget" not in kwargs:
            if db_field.choices:
                ...
                kwargs["widget"] = widgets.DhetAdminAdminNullBooleanSelectWidget()
    ...
    def formfield_for_dbfield(
        ...
        if formfield and isinstance(formfield.widget, RelatedFieldWidgetWrapper):
            formfield.widget.template_name = (
                "dhet_admin/widgets/related_widget_wrapper.html"
            )
