...
from dhet_admin.checks import DhetAdminModelAdminChecks
from dhet_admin.datasets import BaseDataset
from dhet_admin.forms import (
    ActionForm,
    PaginationGenericInlineFormSet,
    PaginationInlineFormSet,
)
from dhet_admin.mixins import (
    ActionModelAdminMixin,
    BaseModelAdminMixin,
    DatasetModelAdminMixin,
)
from dhet_admin.overrides import FORMFIELD_OVERRIDES_INLINE
from dhet_admin.typing import FieldsetsType
from dhet_admin.views import ChangeList
from dhet_admin.widgets import DhetAdminBooleanWidget

checkbox = DhetAdminBooleanWidget(
    {
        "class": "action-select",
...
class ModelAdmin(
    ...
    checks_class = DhetAdminModelAdminChecks
