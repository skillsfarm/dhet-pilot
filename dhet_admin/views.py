...
from dhet_admin.forms import DatasetChangeListSearchForm
...
class DhetAdminModelAdminViewMixin(PermissionRequiredMixin):
    """
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        if not hasattr(self, "model_admin"):
            raise DhetAdminException(
                "DhetAdminModelAdminViewMixin was not provided with 'model_admin' argument"
            )

        if not hasattr(self, "title"):
            raise DhetAdminException(
                "DhetAdminModelAdminViewMixin was not provided with 'title' attribute"
            )
