...
from dhet_admin.fields import DhetAdminAdminField, DhetAdminAdminReadonlyField
...
from dhet_admin.widgets import (
    BASE_INPUT_CLASSES,
    INPUT_CLASSES,
    DhetAdminAdminPasswordWidget,
    DhetAdminAdminRadioSelectWidget,
    DhetAdminAdminSelectWidget,
)


class DhetAdminReadOnlyPasswordHashWidget(ReadOnlyPasswordHashWidget):
    pass
...
class UserCreationForm(BaseUserCreationForm):
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.fields["password1"].widget = DhetAdminAdminPasswordWidget(
            attrs={"autocomplete": "new-password"}
        )
        self.fields["password2"].widget = DhetAdminAdminPasswordWidget(
            attrs={"autocomplete": "new-password"}
        )

        if "usable_password" in self.fields:
            self.fields["usable_password"].widget = DhetAdminAdminRadioSelectWidget(
...
class UserChangeForm(BaseUserChangeForm):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(*args, **kwargs)
        self.fields["password"].widget = DhetAdminReadOnlyPasswordHashWidget()
...
class Fieldline(BaseFieldline):
    def __iter__(
        ...
        Union["DhetAdminAdminReadonlyField", "DhetAdminAdminField"], None, None
    ]:
        for i, field in enumerate(self.fields):
            if field in self.readonly_fields:
                yield DhetAdminAdminReadonlyField(
                    self.form, field, is_first=(i == 0), model_admin=self.model_admin
                )
            else:
                yield DhetAdminAdminField(self.form, field, is_first=(i == 0))
